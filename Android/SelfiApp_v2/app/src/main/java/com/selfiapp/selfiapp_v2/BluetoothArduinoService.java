 ...
 */
public class BluetoothArduinoService extends Service {
    // Debugging
...
//            UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
    ...
    public static BluetoothArduinoService mInstance = null;
        ...
        switch (iCmd) {
            case CMD_CONNECT: {
                ...
                BluetoothDevice device = mAdapter.getRemoteDevice(
                    intent.getStringExtra("DEV").split("\n")[1]);
            ...
            default: {
                Log.w(TAG, "Invalid command: " + iCmd);
            }
        }
...
//        mHandler.sendMessage(msg);
    ...
    public static void write(byte[] out) {
        ...
        if (mInstance == null) {
            Log.w(TAG, "BT Service not running...");
            return;
        }
        ...
        synchronized (mInstance) {
            if (mInstance.mState != STATE_CONNECTED) return;
            r = mInstance.mConnectedThread;
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Log.d(TAG, "Got " + Integer.toString(bytes) + " bytes from Arduino: " + new String(buffer));
