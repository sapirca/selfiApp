...
//        mTargetServer = app.getTargetServerDevice();
        mTargetServer = ConnectToCameraActivity.mTargetDevice;
...
//                	mUsbSerialComm.write(PAN_UP_START);
                    BluetoothArduinoService.write(PAN_UP_START);
                } else if (event.getAction() == MotionEvent.ACTION_UP ||
                		   event.getAction() == MotionEvent.ACTION_CANCEL) {
//                	mUsbSerialComm.write(PAN_UP_STOP);
                    BluetoothArduinoService.write(PAN_UP_STOP);
                }
...
//                	mUsbSerialComm.write(PAN_DOWN_START);
                    BluetoothArduinoService.write(PAN_DOWN_START);
                } else if (event.getAction() == MotionEvent.ACTION_UP ||
                		   event.getAction() == MotionEvent.ACTION_CANCEL) {
//                	mUsbSerialComm.write(PAN_DOWN_STOP);
                    BluetoothArduinoService.write(PAN_DOWN_STOP);
                }
...
//                	mUsbSerialComm.write(PAN_RIGHT_START);
                    BluetoothArduinoService.write(PAN_RIGHT_START);
                } else if (event.getAction() == MotionEvent.ACTION_UP ||
                		   event.getAction() == MotionEvent.ACTION_CANCEL) {
//                	mUsbSerialComm.write(PAN_RIGHT_STOP);
                    BluetoothArduinoService.write(PAN_RIGHT_STOP);
                }
...
//                	mUsbSerialComm.write(PAN_LEFT_START);
                    BluetoothArduinoService.write(PAN_LEFT_START);
                } else if (event.getAction() == MotionEvent.ACTION_UP ||
                		   event.getAction() == MotionEvent.ACTION_CANCEL) {
//                	mUsbSerialComm.write(PAN_LEFT_STOP);
                    BluetoothArduinoService.write(PAN_LEFT_STOP);
                }
...
//                	mUsbSerialComm.write(PAN_SELFI_START);
                    BluetoothArduinoService.write(PAN_SELFI_START);
                } else if (event.getAction() == MotionEvent.ACTION_UP ||
                		   event.getAction() == MotionEvent.ACTION_CANCEL) {
//                	mUsbSerialComm.write(PAN_SELFI_STOP);
                    BluetoothArduinoService.write(PAN_SELFI_STOP);
                }
                return false;
            }
		});
...
//                	mUsbSerialComm.write(PAN_RESET_START);
                    BluetoothArduinoService.write(PAN_RESET_START);
                } else if (event.getAction() == MotionEvent.ACTION_UP ||
                		   event.getAction() == MotionEvent.ACTION_CANCEL) {
//                	mUsbSerialComm.write(PAN_RESET_STOP);
                    BluetoothArduinoService.write(PAN_RESET_STOP);
                }
                return false;
            }
		});
    ...
    protected void onPause() {
        ...
        for( WifiConfiguration i : list ) {
            ...
            if(i.SSID != null && i.SSID.equals("\"" + ConnectToCameraActivity.mCameraSSID + "\"")) {
